(function(global, factory) {
    ...
    function VennDiagram() {
        var width = 600,
            ...
            // Redefining color scheme
            colourScheme = ["#013369", "#198143", "#D3BC8D", "#A8001C", "#FFB612", "#fff", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
            colourIndex = 0,
    ...
    function computeTextCentre(interior, exterior) {
        ...
        var solution = nelderMead(
            function(p) { return -1 * circleMargin({ x: p[0], y: p[1] }, interior, exterior); }, [initial.x, initial.y], { maxIterations: 500, minErrorDelta: 1e-10 }).x;
    ...
    function sortAreas(div, relativeTo) {
        ...
        // UPDATE: changed so that non venn g elements are unaffected by the sorting 
